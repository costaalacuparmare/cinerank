...
### Key Technologies
- Edge Delivery Services for AEM Sites (documentation at https://www.aem.live/ – search with `site:www.aem.live` to restrict web search results; https://www.aem.live/llms.txt gives an AI-optimized overview + links to key docs, worth fetching directly when you need a quick orientation instead of searching)
...
`README.md` before starting any block work: it defines the 4 real features (Library, Duels,
